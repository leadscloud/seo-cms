...
document.writeln("LR_showInviteDiv(\"ยินดีต้อนรับสู่เว็บไซต์ของเรา\",\"นี่เป็นบริการออนไลน์ของเราหากคุณมีคำถามใด ๆ โปรดใช้คำขอการเจรจานี้^_^&nbsp;<br/>นอกจากนี้คุณยังสามารถใช้วิธีต่อไปนี้:<br/>Email:<b> chat@xxxx.net</b>\");");
