...
document.writeln("LR_showInviteDiv(\"به سایت ما خوش آمدید\",\"این سرویس آنلاین ما است. اگر شما هر گونه سوال، لطفا این درخواست دیالوگ را درخواست کنید. ^_^&nbsp;<br/>شما همچنین می توانید با روش های زیر:<br/>Email:<b> chat@xxxx.net</b>\");");
