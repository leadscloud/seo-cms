...
document.writeln("LR_showInviteDiv(\"Chào mừng đén với website của chúng tôi\",\"Đây là Dịch vụ Trực tuyến của chúng tôi.Nếu bạn có bất kỳ câu hỏi nào, vui lòng yêu cầu đối thoại này. ^_^&nbsp;<br/>Bạn cũng có thể theo những cách sau:<br/>Email:<b> chat@xxxx.net</b>\");");
