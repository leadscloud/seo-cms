...
document.writeln("LR_showInviteDiv(\"أهلا في موقعنا\",\"هذا هو لدينا خدمة الانترنت.إذا كان لديك أي أسئلة، يرجى اتخاذ هذا الطلب الحوار. ^_^&nbsp;<br/>يمكنك أيضا من خلال الطرق التالية:<br/>Email:<b> chat@xxxx.net</b>\");");
